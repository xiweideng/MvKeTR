...
def build_optimizer(args, model):
    ve_params_ids = list(map(id, model.coronal_visual_extractor.parameters()))
    ve_params_ids += list(map(id, model.axial_visual_extractor.parameters()))
    ve_params_ids += list(map(id, model.sagittal_visual_extractor.parameters()))
    ed_params = filter(lambda p: id(p) not in ve_params_ids, model.parameters())
    optimizer = getattr(torch.optim, args.optim)(
        [
            {'params': model.coronal_visual_extractor.parameters(), 'lr': args.lr_c_ve},
            {'params': model.axial_visual_extractor.parameters(), 'lr': args.lr_a_ve},
            {'params': model.sagittal_visual_extractor.parameters(), 'lr': args.lr_s_ve},
